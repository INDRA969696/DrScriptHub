...
local hub = DraLibs:window("Unfair Flip")
hub:button("Inf Coin", function()
  game:GetService("ReplicatedStorage").GiveMoney:FireServer(9e500)
end)

hub:button("Inf Gem", function() game:GetService("ReplicatedStorage").GemUpgrades:FireServer("ExtraCardOptions", -9e500 , 1, 2) 
end
)
